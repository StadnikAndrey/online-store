...
<?php require_once ROOT . "/views/admin_menu/index.php";  ?> 				 
	...
	<div class="admin_rigt">	 
	 <h3 class="admin_info_up_title">Изменение информации о компании</h3>
	...
	<form action="" method="POST" enctype="multipart/form-data" class="admin_info_up_form">
		...
		<div class="admin_info_up_form_row">
			...
			<textarea name="adm_info_txt" id=""   rows="25" class="admin_info_up_form_input"><?=
	isset($_POST['adm_info_txt'])?trim($_POST['adm_info_txt']):preg_replace('/(<br>){0,100}/iu','', $info['text']);
			 ?></textarea>
		</div>	 
 		 
		<input type="hidden" name="adm_info_up_submit">
