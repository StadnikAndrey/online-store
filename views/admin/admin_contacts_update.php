...
<?php require_once ROOT . "/views/admin_menu/index.php";  ?> 				 
	...
	<div class="admin_rigt">	 
	 <h3 class="admin_info_up_title">Изменение контактной информации компании</h3>
	...
	<form action="" method="POST" enctype="multipart/form-data" class="admin_info_up_form">
		<div class="admin_info_up_form_row">
			...
			<input type="hidden" name="MAX_FILE_SIZE" value="3000000">
 	        <input type="file" name="img_contact" class="admin_info_up_form_input">			 
		</div>
		...
		<div class="admin_info_up_form_row">
			<label for="" class="admin_info_up_form_label">Контактная информация компании:</label> 
			<textarea name="adm_contacts_txt" id=""   rows="25" class="admin_info_up_form_input"><?=
isset($_POST['adm_contacts_txt'])?trim($_POST['adm_contacts_txt']):preg_replace('/(<br>){0,100}/iu','', $info['text']);
			 ?></textarea>
		</div>	 
 		 
		<input type="hidden" name="adm_contacts_up_submit">
